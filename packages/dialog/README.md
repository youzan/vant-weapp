...
| use-confirm-button-slot `1.10.22` | 是否使用自定义确认按钮的插槽 | _boolean_ | `false` |
| use-cancel-button-slot `1.10.22` | 是否使用自定义取消按钮的插槽 | _boolean_ | `false` |
...
| confirm-button `1.10.22` | 自定义`confirm-button`显示内容，需要 `use-confirm-button-slot` 为 `true` |
| cancel-button `1.10.22` | 自定义`cancel-button`显示内容，需要 `use-cancel-button-slot` 为 `true` |
